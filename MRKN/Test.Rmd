...
head(clim) # read in the data
```


```{r asdate}
date=as.Date(clim$DATE) # command transforms the DATE field in clim table into an R-formatted date array that R knows how to do things with
